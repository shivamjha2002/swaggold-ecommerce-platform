...
def create_app(config_name='development'):
    ...
    # Register blueprints
    from app.routes import products, customers, sales, khata, predictions, prices, auth, analytics, orders, uploads, cart, checkout, webhooks, price_feed, ai, payments, addresses
    ...
    app.register_blueprint(price_feed.bp, url_prefix='/api')
    app.register_blueprint(ai.bp, url_prefix='/api/ai')
    app.register_blueprint(payments.bp, url_prefix='/api')
    app.register_blueprint(addresses.bp, url_prefix='/api/addresses')
    ...
    from app.utils.security import validate_razorpay_keys
    is_valid, error_msg = validate_razorpay_keys()
    if not is_valid:
        app.logger.warning(f'Razorpay configuration issue: {error_msg}')
