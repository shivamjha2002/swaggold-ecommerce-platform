        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Market Price Display (for price-based products) */}
              {product.is_price_based && product.price_symbol && (
                <MarketPriceDisplay
              ...
              <button
                ...
                className={`w-full flex items-center justify-center space-x-3 py-4 px-6 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg ${product.is_active && product.stock_quantity > 0
