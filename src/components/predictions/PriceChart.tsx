    ...
    <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="flex items-center space-x-2 bg-gray-100 rounded-xl p-1">
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-200 ${timeRange === range.value
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className={`bg-gradient-to-br ${stats.change >= 0 ? 'from-green-50 to-green-100' : 'from-red-50 to-red-100'
            } p-4 rounded-xl`}>
            <p className={`text-xs font-semibold mb-1 ${stats.change >= 0 ? 'text-green-600' : 'text-red-600'
              }`}>
              Change
            </p>
      ...
      {loading && (
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-semibold">Loading historical price data...</p>
            <p className="text-gray-500 text-sm mt-2">Fetching {timeRange} days of price trends</p>
          </div>
        </div>
      )}
      ...
      {!loading && !error && data.length === 0 && (
        <div className="flex flex-col items-center justify-center h-96 text-center">
          ...
          <p className="text-gray-500 text-sm mb-4">
            Historical price data needs to be seeded before trends can be displayed.
          </p>
          <p className="text-gray-400 text-xs">
            Contact your administrator to initialize the price history database.
          </p>
        </div>
      )}
